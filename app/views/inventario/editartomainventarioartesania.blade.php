...
<div class="container">
	<div class="row">
	  	...
	  	<div class="formulario col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
			...
			{{Form::open(array('method' => 'POST', 'url' => '/actualizar-toma-inventario-artesania/'.$idOpcion, 'files' => true))}}
			<div class="col-xs-12">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="text-align:center;">
				<input type="submit"  class="btn btn-primary" value="Actualizar Toma Inventario">
			</div>
			{{Form::close()}}
