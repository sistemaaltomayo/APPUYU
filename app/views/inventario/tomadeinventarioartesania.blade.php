        		...
        		<div class="col-xs-12 col-lg-12">
        			<div class="input-group" >
						    ...
						    <span class="input-group-btn">
						    	...
						    	<button class="btnagregarstockA btn btn-success" id="" type="button">
							    	<i class="fa fa-plus fa-lg"></i>
							    	<div style="display:none;" class="loader">Loading...</div>
							    	<i class="fa fa-check" style="display:none;"></i>
							    </button>

							    <button class="btndisminuirstockA btn btn-danger" id="" type="button">
							    ...
							    <button class="btneditstockA btn btn-primary" id="" type="button">
...
@section('script')
	...
	<script type="text/javascript">
			...
			$('.tablapedidodata').on('click', function(event){
				...
				$('.btnagregarstockA').attr("id",$(this).attr('id'));
				$('.btndisminuirstockA').attr("id",$(this).attr('id'));
				$('.btneditstockA').attr("id",$(this).attr('id'));
					...
					if(sw>0){
	                    ...
	                    }).done(function(pagina) 
	                    {
	                        ...
	                        if(pagina==1){
	                            ...
	                            window.location.href = '/getion-inventario-market/'+idopcion;
	                        }
