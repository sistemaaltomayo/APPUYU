			...
			<div class="row">
		                ...
		                <ul class="list-group">
					    	@foreach($tbUsuarioLocal as $item)
					    	 		<li class="list-group-item" id="{{$item->Id}}" style="text-align:left;">
 										...
 										{{ Form::select('C-'.$item->Id, $comboubicacion, $selectedubicacion,['class' => 'form-control control comboubicacion' , 'id' => 'C-'.$item->Id]) }}
					    	 		</li>
					      	@endforeach	
		                </ul>
		            </div>
		        ...
		        <div class="dual-list list-right col-md-5">
		            ...
		            <div class="well">
		                <div class="row">
		                    <div class="col-md-2">
		                    	<button type="button" class="btn btn-success" id="insertarusuarios">
		                ...
		                @foreach($tbUsuarioAgregados as $item)
					    	<li class="list-group-item usuarioinsertado">{{$item->Apellido}} {{$item->Nombre}} -  <strong>{{$item->Descripcion}}</strong></li>
					    @endforeach	
