		...
		<div class="col-xs-12 cabecerageneral">
			...
			<div class="col-xs-12 buscaragregar">
				...
				<div class="agregar col-xs-12 col-sm-4  col-md-4 col-lg-6">
                    ...
                    <a href="{{ url('/insertar-toma-inventario-artesania/'.$idOpcion) }}" class="btn btn-success">
				        		...
				        		<td>
								    <div class="btn-group">
									    ...
									    <ul class="dropdown-menu menulistas">
									      <li><a class='{{$class}}' href="{{ url('/editar-toma-inventario-market/'.$idOpcion.'/'.$item->Id) }}">Modificar</a></li>
